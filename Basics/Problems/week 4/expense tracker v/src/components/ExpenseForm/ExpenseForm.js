...
const ExpenseForm = ({ addExpense, currentExpense, updateExpense }) => {
  ...
  useEffect(() => {
    if (currentExpense) {
      ...
      expenseAmountInput.current.value = Number(currentExpense.amount);
    }
  }, [currentExpense]);
  ...
  return (
    <form className={styles.form} onSubmit={onSubmitHandler}>
      ...
      <h3>{currentExpense ? "Edit Transaction" : "Add Transaction"}</h3>
